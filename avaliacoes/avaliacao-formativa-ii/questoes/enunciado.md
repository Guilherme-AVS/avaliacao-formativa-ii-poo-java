...
A Avaliação Formativa II tem como objetivo verificar a capacidade de aplicar os conceitos de programação em Java trabalhados nas Aulas 01 a 10, evoluindo da construção de programas básicos para a criação de classes com construtores e encapsulamento.
...
**Valor da Avaliação Formativa II: 1,0 ponto no 1º GQ.**
